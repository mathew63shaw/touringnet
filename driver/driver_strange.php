...
$result2 = $db->run("SELECT DATE_FORMAT(MIN(DATE),'%D %b %Y') AS mindate, DATE_FORMAT(MAX(DATE),'%D %b %Y') AS maxdate FROM races WHERE driver = 'Colin TURKINGTON'")->fetch();
		...
		<div class="td-pb-row">
			...
			<div class="td-pb-span8">
				...
				<div class="td-ss-main-content">
					...
					&nbsp;&nbsp;<em>Notee: Data valid for period between <?php if (mysqli_num_rows($result2) > 0) {
